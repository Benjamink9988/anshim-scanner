...
**안심 스캐너 v 2.0**은 Google Gemini AI를 활용하여 생활화학제품, 식품, 의약품의 성분을 **자동으로 분류**하고 안전성과 환경 영향을 심층 분석하는 웹 애플리케이션입니다. 제품 라벨을 스캔하여 사용자가 정보에 기반한 현명한 결정을 내리고, 제품을 올바르게 폐기할 수 있도록 돕습니다.
...
# Anshim Scanner v 2.0

**Anshim Scanner v 2.0** is a web application that leverages Google Gemini AI to **automatically classify** and analyze the safety and environmental impact of **household products, food, and medicines**. By scanning a product label, this app helps users make informed decisions and dispose of products correctly.
