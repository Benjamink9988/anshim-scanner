...
export const RecycleIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M7 19H4.815a1.83 1.83 0 0 1-1.57-.881 1.785 1.785 0 0 1 .024-1.838L9.02 9.5" /><path d="m11 13.5 7.5-7.5" /><path d="M12.232 10.345 7.5 15" /><path d="m14 5 3 3" /><path d="M11.5 21 7 19l.5-4" /><path d="M16 11.5 21 7l-4 .5" /><path d="m5 12.5 4.5-4.5" /><path d="M15 16.5 19 21" /></svg>
);
...
export const InfantIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M9 12.5c0 .55.45 1 1 1h4c.55 0 1-.45 1-1v-5c0-.55-.45-1-1-1h-4c-.55 0-1 .45-1 1v5z" /><path d="M9 7.5V6a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v1.5" /><path d="M12 18.5c-3 0-5-1.5-5-3v-1.5h10V15.5c0 1.5-2 3-5 3z" /></svg>
);
export const PregnantIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="12" cy="7" r="3" /><path d="M10.5 13H8v5" /><path d="M12.5 13H16v5" /><path d="M10 20c-1 0-2-1-2-2v-3h1.5" /><path d="M14 20c1 0 2-1 2-2v-3h-1.5" /><path d="M15.5 13a3.5 3.5 0 0 0-7 0" /></svg>
);
export const PetIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 13.5c-1.66 0-3-1.57-3-3.5s1.34-3.5 3-3.5 3 1.57 3 3.5-1.34 3.5-3 3.5z" /><path d="M18.81 12.5c.34 0 .65.06.94.19" /><path d="M5.19 12.5A2.19 2.19 0 0 1 3 10.31V9.5a2.5 2.5 0 0 1 2.5-2.5c1.1 0 2.06.74 2.39 1.76" /><path d="M16.11 7.76c.33-1.02 1.29-1.76 2.39-1.76A2.5 2.5 0 0 1 21 8.5v.81a2.19 2.19 0 0 1-2.19 2.19" /><path d="M9.5 19.5c-2.21 0-4-1.79-4-4v-2c0-2.21 1.79-4 4-4" /><path d="M14.5 19.5c2.21 0 4-1.79 4-4v-2c0-2.21-1.79-4-4-4" /></svg>
);
export const RespiratoryIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 22c-4 0-6-2-6-4v-2.5c0-.83.67-1.5 1.5-1.5h1c.83 0 1.5.67 1.5 1.5V18" /><path d="M12 22c4 0 6-2 6-4v-2.5c0-.83-.67-1.5-1.5-1.5h-1c-.83 0-1.5.67-1.5 1.5V18" /><path d="M12 14v-4" /><path d="M12 10V4.5a2.5 2.5 0 0 0-5 0V10" /><path d="M12 10V4.5a2.5 2.5 0 0 1 5 0V10" /><path d="M7 10h10" /></svg>
);
export const LeafIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M11 20A7 7 0 0 1 4 13V8a5 5 0 0 1 9-3 5 5 0 0 1 9 3v5a7 7 0 0 1-7 7h-2z" /><path d="M12 22V14" /></svg>
);
...
export const UtensilsCrossedIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="m16 2-2.3 2.3a3 3 0 0 0 0 4.2l1.8 1.8a3 3 0 0 0 4.2 0L22 8Z" /><path d="M15 15 3.34 3.34" /><path d="m22 16-6 6" /><path d="m2 16 6 6" /><path d="M14.5 11.5 10 7" /></svg>
);
